...
// CANCDU - type 36
//
module.exports.CANCDU = class CANCDU extends CbusModule{
	constructor(nodeNumber) {
		super(nodeNumber);			// Call parent class constructor
               //1234567//
		this.NAME = "CDU    ";
		...
		this.parameters[1] = 165;								// Manufacturer Id - MERG
		this.parameters[2] = "c".charCodeAt(0);	// Minor version number - 98 (0x62)
		this.parameters[3] = 36;								// Module Id - 0x24
		this.parameters[4] = 128;								// Number of supported events
		this.parameters[5] = 2;									// Number of event variables
		this.parameters[6] = 16;								// Number of Node Variables
		this.parameters[7] = 1;									// Major version number
...
// CANDISP - ID 59
//
module.exports.CANDISP = class CANDISP extends CbusModule{
	constructor(nodeNumber) {
		super(nodeNumber);			// Call parent class constructor
               //1234567//
		this.NAME = "DISP   ";
		...
		this.parameters[1] = 165;								// Manufacturer Id - MERG
		this.parameters[2] = "D".charCodeAt(0);	// Minor version number - decimal 103 (0x67)
		this.parameters[3] = 59;								// Module Id
		this.parameters[4] = 128;								// Number of supported events
		this.parameters[5] = 17;								// Number of event variables
		this.parameters[6] = 1;									// Number of Node Variables
		this.parameters[7] = 4;									// Major version number
...
//
// 2 - slot test module SLOTTEST
//
module.exports.SLOTTEST = class SLOTTEST extends CbusModule{
	constructor(nodeNumber) {
		super(nodeNumber);			// Call parent class constructor
